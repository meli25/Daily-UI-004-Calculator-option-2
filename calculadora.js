...
let calcuElement = document.getElementById('calcu');
let display = document.createElement('div');
display.classList.add('calcu-display');
...
calcuElement.appendChild(display);
calcuElement.appendChild(clearButton);
